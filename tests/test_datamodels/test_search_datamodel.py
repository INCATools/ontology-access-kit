...
from oaklib.datamodels.search import create_search_configuration, DEFAULT_SEARCH_PROPERTIES
from oaklib.datamodels import search_datamodel
from oaklib.datamodels.search_datamodel import SearchProperty, SearchTermSyntax

from tests import output_path, NUCLEUS
