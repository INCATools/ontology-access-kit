...
SEMSIMIAN_ECTO_PROFILE = "oak_semsimian_ecto.profile"
NON_SEMSIMIAN_ECTO_PROFILE = "oak_ecto.profile"
ECTO_TERMS = "ECTO_terms.txt"
HP_TERMS = "HPO_terms.txt"
MP_TERMS = "MP_terms.txt"
PROFILER_SCRIPT= "src/oaklib/implementations/semsimian/profiler.py"

run_benchmark: hp-benchmarks hp-profiles
...
# ECTO children of exposure event or process (RO:0002310) - this is about 2,800 terms
ecto-benchmarks:
...
ecto-profiles:
	...
	python $(PROFILER_SCRIPT) $(NON_SEMSIMIAN_ECTO_PROFILE)
