...
from oaklib.datamodels.vocabulary import IS_A, PART_OF, HAS_DBXREF, HAS_DEFINITION_CURIE
...
class StreamingCsvWriter(StreamingWriter):
    ...
    def _get_dict(self, curie: CURIE):
        ...
        if isinstance(oi, SemanticSimilarityInterface):
            ...
            d['information_content_via_is_a_part_of'] = oi.get_information_content(curie, predicates=[IS_A, PART_OF])
