...
from kgcl_schema.datamodel.kgcl import ChangeLanguageElement, NodeChange, EdgeChange, NodeMove
    ...
    def emit(self, curie, label=None, **kwargs):
        ...
        if isinstance(curie, ChangeLanguageElement):
            if isinstance(curie, NodeChange):
                ...
                change = curie
                # !Here we only have only SPO e.g.: subject='PATO:0045073', predicate='RO:0015010', object='PATO:0000461'
        ...
        if self.display_options and "t" in self.display_options and isinstance(oi, TaxonConstraintInterface):
