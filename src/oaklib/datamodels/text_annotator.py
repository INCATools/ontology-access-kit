...
slots.textAnnotationConfiguration__forward_text_file = Slot(
    uri=ANN.forward_text_file,
    name="textAnnotationConfiguration__forward_text_file",
    curie=ANN.curie("forward_text_file"),
    model_uri=ANN.textAnnotationConfiguration__forward_text_file,
    domain=None,
    range=Optional[Union[bool, Bool]],
)
