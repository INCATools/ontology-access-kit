...
class TransformationType(EnumDefinitionImpl):
    ...
    Synonymization = PermissibleValue(text="Synonymization",
...
slots.relationshipToTerm__synonymized = Slot(uri=MRULES.synonymized, name="relationshipToTerm__synonymized", curie=MRULES.curie('synonymized'),
                   model_uri=MRULES.relationshipToTerm__synonymized, domain=None, range=Optional[Union[bool, Bool]])
