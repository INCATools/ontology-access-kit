...
slots.synonymizer__tests = Slot(
    ...
    curie=MRULES.curie("tests"),
    model_uri=MRULES.synonymizer__tests,
    domain=None,
...
slots.test__input = Slot(
    uri=MRULES.input,
    name="test__input",
    curie=MRULES.curie("input"),
    model_uri=MRULES.test__input,
    domain=None,
    range=Optional[str],
)
...
slots.test__output = Slot(
    uri=MRULES.output,
    name="test__output",
    curie=MRULES.curie("output"),
    model_uri=MRULES.test__output,
    domain=None,
    range=Optional[str],
)
