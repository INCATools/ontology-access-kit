...
slots.relationshipToTerm__synonymized = Slot(uri=LI.synonymized, name="relationshipToTerm__synonymized", curie=LI.curie('synonymized'),
                   model_uri=LI.relationshipToTerm__synonymized, domain=None, range=Optional[Union[bool, Bool]])
