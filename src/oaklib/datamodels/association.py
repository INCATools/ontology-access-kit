...
class PairwiseCoAssociation(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.proportion_subjects_in_common is not None and not isinstance(
            self.proportion_subjects_in_common, float
        ):
            self.proportion_subjects_in_common = float(self.proportion_subjects_in_common)

        if self.number_subjects_in_union is not None and not isinstance(
            self.number_subjects_in_union, int
        ):
...
slots.proportion_subjects_in_common = Slot(
    uri=ONTOASSOC.proportion_subjects_in_common,
    name="proportion_subjects_in_common",
    curie=ONTOASSOC.curie("proportion_subjects_in_common"),
    model_uri=ONTOASSOC.proportion_subjects_in_common,
    domain=None,
    range=Optional[float],
)

slots.number_subjects_in_union = Slot(
    uri=ONTOASSOC.number_subjects_in_union,
    name="number_subjects_in_union",
    curie=ONTOASSOC.curie("number_subjects_in_union"),
    model_uri=ONTOASSOC.number_subjects_in_union,
    domain=None,
    range=Optional[int],
)
