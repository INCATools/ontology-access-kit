...
slots.id = Slot(uri=OG.id, name="id", curie=OG.curie('id'),
                   model_uri=OG.id, domain=None, range=URIRef)
...
slots.logicalDefinitionAxiom__definedClassId = Slot(uri=OG.definedClassId, name="logicalDefinitionAxiom__definedClassId", curie=OG.curie('definedClassId'),
                   model_uri=OG.logicalDefinitionAxiom__definedClassId, domain=None, range=Optional[str])

slots.logicalDefinitionAxiom__genusIds = Slot(uri=OG.genusIds, name="logicalDefinitionAxiom__genusIds", curie=OG.curie('genusIds'),
                   model_uri=OG.logicalDefinitionAxiom__genusIds, domain=None, range=Optional[Union[str, List[str]]])

slots.logicalDefinitionAxiom__restrictions = Slot(uri=OG.restrictions, name="logicalDefinitionAxiom__restrictions", curie=OG.curie('restrictions'),
                   model_uri=OG.logicalDefinitionAxiom__restrictions, domain=None, range=Optional[Union[Union[dict, ExistentialRestrictionExpression], List[Union[dict, ExistentialRestrictionExpression]]]])
